...
import { updatearticle } from '../../services/articles/articleservice';
import {fetchscategories} from "../../services/scategories/scategorieservice"
...
data.append('upload_preset', 'Fichier1');
data.append('cloud_name', 'dmiuwxkox');
data.append('public_id', file.name);
axios.post('https://api.cloudinary.com/v1_1/dmiuwxkox/image/upload', data)
